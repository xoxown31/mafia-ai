...
def train(env, agent, args, log_file):
    ...
    for episode in range(1, args.episodes + 1):
        ...
        log_file.write(f"Episode {episode} End. Total Reward: {total_reward:.2f}, Win: {is_win}\n")
        
        if episode % 100 == 0:
            print(f"Ep {episode:5d} | Score: {total_reward:6.2f} | Win Rate: {current_win_rate*100:3.0f}%")
